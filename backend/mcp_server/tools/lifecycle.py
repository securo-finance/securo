...
async def list_recurring_transactions(*, session: AsyncSession, ctx: CallContext) -> dict[str, Any]:
    ...
    items = [
        {
            ...
            if getattr(r, "next_occurrence", None)
            else None,
    ...
    parameters={
        ...
        "properties": {
            "month": {
                "type": "string",
                "format": "date",
                "description": "Any date inside the target month; omit for all months",
            },
        },
        "additionalProperties": False,
    },
