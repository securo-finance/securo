...
DEFAULT_GROUPS_I18N = {
    "housing":   {"ru": "Жильё", "it": "Casa", "pl": "Mieszkanie", "es": "Alojamiento", "en": "Housing",       "pt-BR": "Moradia",         "icon": "house",            "color": "#8B5CF6", "position": 0},
    "food":      {"ru": "Еда и рестораны", "it": "Cibo e Ristoranti", "pl": "Jedzenie", "es": "Comida y Cena", "en": "Food & Dining", "pt-BR": "Alimentação",     "icon": "utensils-crossed", "color": "#F59E0B", "position": 1},
    "transport":  {"ru": "Транспорт", "it": "Trasporti", "pl": "Transport", "es": "Transporte",     "en": "Transport",     "pt-BR": "Transporte",      "icon": "car",              "color": "#3B82F6", "position": 2},
    "lifestyle": {"ru": "Образ жизни", "it": "Stile di Vita", "pl": "Styl życia", "es": "Estilo de Vida", "en": "Lifestyle",     "pt-BR": "Estilo de Vida",  "icon": "sparkles",         "color": "#EC4899", "position": 3},
    "income":    {"ru": "Доходы", "it": "Entrate", "pl": "Przychody", "es": "Ingresos",        "en": "Income",        "pt-BR": "Renda",           "icon": "trending-up",      "color": "#16A34A", "position": 5},
    "other":     {"ru": "Другое", "it": "Altro", "pl": "Inne", "es": "Otros",            "en": "Other",         "pt-BR": "Outros",          "icon": "circle-help",      "color": "#64748B", "position": 4},
}
